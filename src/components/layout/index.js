...
function Layout({head, content, children, basket, basketLayout, setActive}) {
    ...
    function basketButton() {
        if (basket) {
            return (<div className='Layout__head-basket'>
                    <div className='Layout__head'>
                        {head}
                    </div>
                    <div className="Layout__close-btn" onClick={() => setActive(false)}>
    ...
    function basketSum() {
        if (basket) {
            return <div className="Layout__basket-sum">
                <div className="Layout__basket-sum-empty"></div>
